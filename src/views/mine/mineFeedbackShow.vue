...
<style scoped>
  ...
  .content .title{line-height: 0.35rem; color: #e0002a; padding-left: 0.25rem; position: relative;}
  .content .title:before{width: 0.05rem; height: 0.12rem; content: ''; position: absolute; left: 0.1rem; top: 0.11rem; background: #e0002a;}
