...
<style scoped>
  ...
  .ManagerView .ul_workBench .li_workBench{display: flex; flex-direction: column; align-content: space-around; justify-content: space-around; width: 25%; height: 0.55rem; text-align: center;}
  .ManagerView .ul_workBench .li_workBench:nth-child(n+5){margin-top: 0.15rem;}
