...
<template>
  <div class="headerView">
    ...
    <template v-if="popBg">
      <div class="popBg">
        <search-my-work @change="updatePopBg" @search="searchData" :queryData="queryData"></search-my-work>
      </div>
    </template>
  </div>
</template>
...
<script>
import searchMyWork from '@/components/searchMyWork'
export default {
  name: 'headerBaseSeven',
