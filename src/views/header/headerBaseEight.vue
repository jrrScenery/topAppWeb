...
export default {
  ...
  methods: {
    ...
    onAddParts () {
      this.$router.push({name:"addParts",query:{caseId: this.$route.query.caseId}});
    },
...
<style scoped>
  ...
  .popBg{background: rgba(0,0,0,0.5); position: fixed; top: 0.45rem; bottom: 0; z-index: 999; padding: 0 0.28rem;}
</style>