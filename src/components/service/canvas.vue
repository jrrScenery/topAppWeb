...
<style scoped> 
  .helloView{width: 80%; background: #ffffff; padding: 0.1rem 0.2rem 0.4rem; position: relative;}
  .helloView >>> .el-form-item{margin-bottom: 0.05rem;}
  .helloView >>> .searchBtn{position: absolute; bottom: 0; left: 0; right: 0; height: 0.4rem;}
