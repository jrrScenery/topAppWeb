<template>
  <div class="workDayView">
    <div class="workDayContent">
...
.workDayContent >>> .el-table--border::after,
...
/* .workDayContent >>> .timePicker {
  width: 80%;
}
.workDayContent >>> .timePicker .el-input__inner {
  padding-left: 0.05rem;
  text-align: center;
  padding-right: 0;
} */
.workDayContent >>> .el-table .cell,
.el-table th {
  padding: 0;
  text-align: center;
}
/* .workDayContent >>> .el-textarea__inner {
  padding: 0.05rem;
  height: 100%;
} */

.workDayView >>> .el-button {
  display: flex;
  align-items: center;
  justify-content: center;
}
.workDayView .el-form-item{margin-bottom: 0.08rem}
...
.workDayContent >>> .norecord {
  text-align: center;
  margin-top: 0.3rem;
  color: #999999;
}
.workDayContent >>> .el-button{margin-left: 0.2rem}
.workDayContent >>> .searchBtn .el-button:hover {
  background: #ffffff;
}
.workDayContent >>> .searchBtn .searchBtnCell:hover {
  background: #2698d6;
}
.workDayContent >>> .searchBtn .el-form-item__content {
  margin: 0 !important;
  display: flex;
}
.workDayContent >>> .searchBtn .searchBtnCell {
  background: #2698d6;
  color: #ffffff;
}
</style>