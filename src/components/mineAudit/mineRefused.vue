<template>
    <div class="mineRefusedView">
        <div class="mineRefusedContent">
            <el-form>
                ...
                <div class="norecord" v-else>暂无驳回记录</div>
            </el-form>
        </div>
    </div>
</template>
...
export default {
    ...
    methods:{
        queryMyAttendanceList(){
            fetch.get("?action=/attendance/queryMyAttendanceList&processStatus=3").then(res=>{
...
<style scoped>
.mineRefusedContent{padding: 0.1rem;background: #ffffff;overflow: scroll}
.mineRefusedContent{padding: 0.1rem;background: #ffffff;overflow: scroll}
.mineRefusedContent >>> .el-form-item{margin-bottom: 0rem;}
.mineRefusedContent >>> .el-form-item .el-form-item__label{line-height: 0.3rem}
.mineRefusedContent >>> .el-form-item .el-form-item__content{line-height: 0.3rem}
.mineRefusedView>>>.submitBtn{margin-top: 0.1rem; bottom: 0; left: 0; right: 0; height: 0.4rem;}
.mineRefusedView >>>.submitBtn .el-button{width: 50%; border: none; padding: 0; margin: 0; height: 0.4rem; border-radius: 0; color: #999999; font-size: 0.13rem;}
.mineRefusedView >>> .submitBtn .el-button:hover{background: #ffffff;}
.mineRefusedView >>> .submitBtn .okBtn:hover{background: #2698d6;}
.mineRefusedView >>> .submitBtn .el-form-item__content{margin: 0!important; display: flex;}
.mineRefusedView >>> .submitBtn .okBtn{background: #2698d6; color: #ffffff;}

.mineRefusedView >>> .divBtn{font-size:0.13rem;float:right;padding: 3px 0;}
.mineRefusedView >>> .proBtn{padding:0.08rem 0.1rem}
.mineRefusedView >>> .submitBtn .modifyBtn{width: 100%;}
.mineRefusedContent>>>.norecord{text-align: center;margin-top: 0.3rem;color: #999999}
</style>